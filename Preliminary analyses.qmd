...
sdg_data <- sdg_data |> 
  mutate(
    health_related = factor(case_when(
      ...
      ~ "Health-related",
      str_detect(tolower(text), keywords_comb1)&
        str_detect(tolower(text), keywords_comb2)~ "Health-related",
